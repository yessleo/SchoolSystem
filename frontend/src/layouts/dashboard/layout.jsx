...
import { navData as dashboardNavDataStaff } from '../config-nav-dashboardStaff';
import { navData as dashboardNavDataDocent } from '../config-nav-dashboardDocent';
import { RoleBasedGuard } from 'src/auth/guard';

// ----------------------------------------------------------------------

function NavDatabyRole() {
  const role = sessionStorage.getItem("role")
  console.log(role)
  let nav;
  if (role == "admin") {
    nav = dashboardNavData;
  } else if( role == "staff") {
    nav = dashboardNavDataStaff;
  }else if( role == "docent") {
    nav = dashboardNavDataDocent
  }
  return nav;
}
