...
export function UserTableToolbar({data, filters, options, onResetPage }) {
  ...
  const DownloadXlsx = () => {
    ...
    XLSX.utils.sheet_add_aoa(worksheet, [
      ["User ID", "Username", "Role", "Status", "Created_at" ],
    ]);
    const cells_width = []
    ...
    const rptname = "Users" + new Date().toLocaleDateString(undefined, options) + ".xlsx"
