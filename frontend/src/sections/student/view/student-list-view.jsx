...
import { useGetStudents, deleteStudent } from 'src/actions/student';
...
const TABLE_HEAD = [
  ...
  { id: 'clase', label: 'Clase', width: 180 },
  { id: '', width: 88 },
];
...
export function StudentListView() {
  ...
  useEffect(() => {
    useGetStudents().then(result => setTableData(result.data));
  }, []);
